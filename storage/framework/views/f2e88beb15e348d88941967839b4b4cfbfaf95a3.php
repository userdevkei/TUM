        ...
        <div class="content-side">
          <ul class="nav-main">
            ...
            <li class="nav-main-item">
              ...
              <a class="nav-main-link <?php echo e(request()->is('approve/approveIndex') ? ' active' : ''); ?>" href="<?php echo e(route('courses.approveIndex')); ?>">
...
<?php /**PATH /var/www/html/tumNew/resources/views/layouts/backend.blade.php ENDPATH**/ ?>