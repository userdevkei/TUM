                   ...
                   <form class="row row-cols-lg-auto g-3 align-items-center" action="<?php echo e(route('courses.updateClasses',$data->id)); ?>" method="POST">
                    ...
                    <div class="col-12 col-xl-12">
                      <select name="intake_from" id="intake_from" class="form-control form-control-alt">
                        <option selected disabled><?php echo e($data->name); ?></option>
                    ...
                    <div class="col-12 col-xl-12">
                      <select name="attendance" id="attendance"value="<?php echo e($data->attendance); ?>" class="form-control form-control-alt">
                        <option  disabled> <?php echo e($data->attendance_id); ?></option>
                    ...
                    <div class="col-12 col-xl-12">
                      <select name="course" id="course" value="<?php echo e($data->course); ?>"class="form-control form-control-alt">
                        <option selected disabled> <?php echo e($data->course_id); ?></option>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/tumNew/Modules/Courses/Resources/views/class/editClasses.blade.php ENDPATH**/ ?>