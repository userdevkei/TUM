              ...
              <table class="table table-borderless table-striped table-vcenter js-dataTable-responsive">
                ...
                <tbody><?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $intake): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    ...
                    <a  class="btn btn-sm btn-alt-success" href="<?php echo e(route('courses.editstatusIntake', $intake->id)); ?>">Active</a>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/tumNew/Modules/Courses/Resources/views/intake/showIntake.blade.php ENDPATH**/ ?>