                        ...
                        <div class="timeline-event-block block">
                            ...
                            <div class="block-content">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="py-2 mb-0">
                                        You are required to pay <span class="fw-bold">Ksh. <?php echo e($course->fee); ?> </span> to complete this application.
                                        ...
                                        <div class="text-uppercase" style="padding: 7px !important;">
                                            <input type="text" class="form-control form-control-alt" required value="<?php echo e(old('receipt')); ?>" name="receipt" placeholder="Enter RECEIPT NUMBER">
                                        </div>
                                        <div class="text-uppercase" style="padding: 7px !important;">
                                            <input type="file" class="form-control form-control-alt" required value="<?php echo e(old('receipt_file')); ?>" name="receipt_file">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('application::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/tum/application/Modules/Application/Resources/views/applicant/application.blade.php ENDPATH**/ ?>