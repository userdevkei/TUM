        ...
        <div class="content-side">
          <ul class="nav-main">
              ...
              <a class="nav-main-link<?php echo e(request()->is('dashboard') ? ' active' : ''); ?>" href="<?php echo e(route('dashboard')); ?>">
                ...
                <span class="nav-main-link-name">
                    ...
                    <?php elseif(auth()->guard('user')->user()->id === 4): ?>
                        DEAN
                    <?php elseif(auth()->guard('user')->user()->id === 3): ?>
                        Students' finance
                    <?php else: ?>
            ...
            <li class="nav-main-item<?php echo e(request()->is('intakes/*') ? ' open' : ''); ?>">
              <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="true" href="<?php echo e(route('finance.applications')); ?>">
                <i class="nav-main-link-icon si si-graduation"></i>
                <span class="nav-main-link-name">Applications</span>
              </a>
              <ul class="nav-main-submenu">
                  <li class="nav-main-item">
                      <a class="nav-main-link<?php echo e(request()->is('intake/showIntake') ? ' active' : ''); ?>" href="<?php echo e(route('finance.applications')); ?>">
                    ...
                    <li class="nav-main-item">
                          <a class="nav-main-link<?php echo e(request()->is('school/showSchool') ? ' active' : ''); ?>" href="<?php echo e(route('finance.batch')); ?>">
                            <i class="nav-main-link-icon si si-graduation"></i>
...
<?php /**PATH C:\xampp\htdocs\sims\application\Modules/Finance\Resources/views/layouts/backend.blade.php ENDPATH**/ ?>