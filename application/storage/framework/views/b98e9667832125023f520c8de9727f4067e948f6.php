                      ...
                      <select name="attendance" value="<?php echo e(old('attendance')); ?>" class="form-control form-control-alt">
                        <option selected disabled> Select Attendance</option>
                          ...
                          <?php $__currentLoopData = $attendances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attend): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($attend->attendance_name); ?>"><?php echo e($attend->attendance_name); ?></option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          <input type="hidden" name="attendance_code" value="<?php echo e($attend->attendance_code); ?>">
                      </select>
                    </div>
                    <div class="col-12 col-xl-12">
                      ...
                      <select name="course" id="course" class="form-control form-control-alt">
                        ...
                        <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($item->course_name); ?>"><?php echo e($item->course_name); ?></option>
                              <input type="hidden" name="course_code" value="<?php echo e($item->course_code); ?>">
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sims\application\Modules/Courses\Resources/views/class/addClasses.blade.php ENDPATH**/ ?>