<?php $__env->startSection('content'); ?>
    ...
    <div class="content">
        ...
        <div class="d-flex justify-content-center py-1">
            <a class="btn btn-sm btn-alt-success m-2" data-toggle="click-ripple" href="<?php echo e(route('finance.acceptApplication', $app->id)); ?>">Approve</a>
            ...
            <div class="modal-content">
                <div class="block block-rounded block-transparent mb-0">
                    ...
                    <div class="block-content fs-sm">
                        <form action="<?php echo e(route('finance.rejectApplication', $app->id)); ?>" method="post">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('applications::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sims\application\Modules/Finance\Resources/views/applications/viewApplication.blade.php ENDPATH**/ ?>